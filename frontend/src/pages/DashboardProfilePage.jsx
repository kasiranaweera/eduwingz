...
const DashboardProfilePage = () => {
  ...
  const repos = profile?.repositories || [
    {
      ...
      description: 'A collection of awesome React components for modern web apps',
      language: 'JavaScript',
      stars: 245,
      forks: 67,
      color: '#f1e05a',
  ...
  const skills = profile?.skills || ['React', 'Node.js', 'TypeScript', 'Python', 'Docker', 'AWS'];
          ...
          <Grid item xs={12} md={4}>
            ...
            >
              ...
              <Box sx={{ textAlign: 'center', mb: 3 }}>
                <Avatar
                  src={profile?.avatar || user?.avatar || `https://ui-avatars.com/api/?name=${user?.displayName || 'User'}&size=280&background=0D8ABC&color=fff`}
                  sx={{
                    width: 280,
                    height: 280,
                    mx: 'auto',
                ...
                />
                <Typography variant="h5" sx={{ fontWeight: 600, mb: 0.5, color: '#c9d1d9' }}>
              ...
              {/* Skills */}
              <Box>
                <Typography variant="subtitle2" sx={{ mb: 2, fontWeight: 600, color: '#c9d1d9' }}>
                  Skills
                </Typography>
              ...
              <Box sx={{ p: 3 }}>
                      ...
                      >
                        <CardContent>
                          <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                            ...
                            <Chip label="Public" size="small" sx={{ bgcolor: 'transparent', color: '#8b949e', border: '1px solid #30363d' }} />
                          </Box>
                          ...
                          <Box sx={{ display: 'flex', gap: 3 }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                              <Box sx={{ width: 12, height: 12, borderRadius: '50%', bgcolor: repo.color }} />
                              <Typography variant="body2" sx={{ color: '#c9d1d9' }}>{repo.language}</Typography>
                            </Box>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                              <Star sx={{ fontSize: 16 }} />
                ...
                {activeTab === 1 && (
                  <Box sx={{ textAlign: 'center', py: 8 }}>
                    ...
                    <Typography sx={{ color: '#8b949e' }}>No projects to show</Typography>
                  </Box>
                )}
                ...
                {activeTab === 2 && (
                  <Box sx={{ textAlign: 'center', py: 8 }}>
                    ...
                    <Typography sx={{ color: '#8b949e' }}>No starred repositories yet</Typography>
                  </Box>
                )}
              </Box>
            </Paper>
